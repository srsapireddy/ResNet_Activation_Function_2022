# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 00:50:20 2021
...
# remove categorical_features from here
...
"""
# working
# Tensor("bn_conv1_5/cond/Identity:0", shape=(None, 32, 32, 64), dtype=float32)
print("----------------------------------------------------------------------")
...
print(inter_output_model)
"""

print("----------------------------------------------------------------------")

"""
# <tensorflow.python.keras.backend.EagerExecutionFunction object at 0x000001FC003FE400>
import tensorflow as tf
...
# with a Sequential model
get_3rd_layer_output = K.function([model.input],[model.get_layer(index=3).output])
#layer_output = get_3rd_layer_output([x])[0]
